...
/////////////////
const BotName = 'Cogan BOT☄'; 
const instagram = 'https://muhammadrizky08official'; 
const telegram = 'https://t.me/reuzzz'; 
const kapanbotaktif = '24 jam'; 
const youtube = 'https://www.youtube.com/channel/UCZB755yr8YEmwlGUJQscDMg';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by Rizky.id')
